...
Version  : 1.0.9
Release  : 68
URL      : https://cran.r-project.org/src/contrib/dplyr_1.0.9.tar.gz
Source0  : https://cran.r-project.org/src/contrib/dplyr_1.0.9.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1651181694
