...
Version  : 1.0.5
Release  : 54
URL      : https://cran.r-project.org/src/contrib/dplyr_1.0.5.tar.gz
Source0  : https://cran.r-project.org/src/contrib/dplyr_1.0.5.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1614960397
