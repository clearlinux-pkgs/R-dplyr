...
Source0  : https://cran.r-project.org/src/contrib/dplyr_1.1.4.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1737139742
...
/usr/lib64/R/library/dplyr/tests/testthat/helper-lazy.R
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/dplyr/libs/dplyr.so
/V4/usr/lib64/R/library/dplyr/libs/dplyr.so
